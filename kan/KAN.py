...
class KAN(nn.Module):
    ...
    def plot(self, folder="./figures", beta=3, mask=False, mode="supervised", scale=0.5, tick=False, sample=False, in_vars=None, out_vars=None, title=None, site_img='fig'):
        '''
        plot KAN
        ...
        plt.savefig(f'{folder}/{site_img}.png', dpi=2000)
        print(f" \n The model visualization has been saved to {folder}/{site_img}.png")
